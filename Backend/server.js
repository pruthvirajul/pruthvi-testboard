...
const allowedOrigins = [
  'http://127.0.0.1:5500',
  'http://13.60.255.98:3105',
  'http://13.60.255.98:8152', // ✅ Add the Login frontend origin
  'http://13.60.255.98:8150', // ✅ Optionally, add Dashboard or others too
  'http://13.60.255.98:8151',
  'http://13.60.255.98:8153'
];
...
initDatabase().then(() => {
  app.listen(port, () => {
    console.log(`Server running on http://13.60.255.98:${port}`);
